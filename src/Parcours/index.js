        ...
        <div className="parcours-content">
            <h1 data-aos="fade-left">Expériences professionnelles</h1>
                ...
                <h2 data-aos="fade-left">Formation O'clock développeur web fullstack // 6 mois</h2> 
                    ...
                    <p data-aos="fade-right">Consulter tout le programme <a href="https://oclock.io/formations/developpeur-web" target="_blank" >ici</a></p>
                <h2 data-aos="fade-left">Rédaction web SEO // 5 ans</h2>
                    <p data-aos="fade-right">D'abord sous contrat puis en indépendant, je me suis occupé de la gestion du catalogue, définition de la stratégie de contenu, analyse de l'audience et du positionnement, optimisation du contenu (SEO), analyse de l'audience et du positionnement (Google Analytics, SEM RUSH, Search Console)</p>
        </div>
    </div>
  );
}
