    ...
    <div className="presentation-container" id="a-propos">
      ...
      <div className="text-about">
        <h2 data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">À Propos :</h2>
          ...
          <p data-aos="fade-up" data-aos-anchor-placement="bottom-bottom">
            J'aime particulièrement développé des interfaces intuitives et offrant une expériences utilisateurs simple sans tout en travaillant sur une identité  esthétique. Pour le moment je tente de monter en compétence en Typescript et Three.js.
          </p>
        <DownloadItem />
      </div>
    </div>
